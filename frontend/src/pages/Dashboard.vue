<template>
  <section>
      ...
      <div class="card-body">
        <div style="max-height: 300px; overflow: scroll">
          <data-tables ref="ordersTable" :data="orders" :page-size="pageSize" :pagination-props="{ pageSizes: [5, 10, 15, 20] }"
                    ...
                    <el-table-column fixed :formatter="cellValueRenderer" v-for="title in titles" :prop="title.prop" :label="title.label" :key="title.label" sortable="custom"></el-table-column>
                </data-tables>
        </div>
      </div>
      <div class="card-footer">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div style="max-height: 300px; overflow: scroll">
          <h3 style="text-align: center">Vue Tables 2 - Server Side Demo</h3>
