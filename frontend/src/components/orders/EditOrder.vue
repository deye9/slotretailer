  ...
  <section>
    ...
    <div class="form-row">
      ...
      <div class="form-group col">
        ...
        <input type="text" class="form-control" placeholder="Phone Number" v-model="phone1" required />
      </div>
    </div>
    ...
    <button type="submit" class="btn btn-primary float-right" @click="Modification">Update Customer</button>
  </section>
</template>
